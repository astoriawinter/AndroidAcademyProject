...
class MovieAdapter(private val clickListener: (Movie) -> Unit) : RecyclerView.Adapter<MovieAdapter.MovieViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder =
            MovieViewHolder(
                    LayoutInflater.from(parent.context).inflate(R.layout.item_movie, parent, false), clickListener
            )
    ...
    class MovieViewHolder(itemView: View, val clickListener: (Movie) -> Unit) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: Movie) {
            ...
            reviewsNumber.text = itemView.context.getString(R.string.reviews_number, item.reviewNumber)
